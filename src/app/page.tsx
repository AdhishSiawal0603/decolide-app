            ...
            <AlertDescription>
              ...
              <p className="mt-2 font-mono bg-destructive/20 p-2 rounded-md text-xs">
               ...
               <p className="mt-3 text-xs">
                Please double-check your configuration. If running locally, check your `.env` file. If this is on the live server, ensure the `SHOPIFY_STORE_NAME` and `SHOPIFY_ADMIN_API_ACCESS_TOKEN` secrets are correctly set in Google Cloud Secret Manager and connected in `apphosting.yaml`.
              </p>
            </AlertDescription>
          </Alert>
      </main>
